...
#include "../Analyse_Lexicale/analyse_automates/structures.h"      // struct existantes
#include "../Analyse_Lexicale/analyse_automates/lexer.h"           // analyseur lexicla
#include "../Analyse_Lexicale/analyse_automates/symbol_table.h"    // Table des symboles
#include "../Analyse_Lexicale/analyse_automates/error_manager.h"   // handling errors
