...
#include "../Analyse_Lexicale_Automates/structures.h"      // struct existantes
#include "../Analyse_Lexicale_Automates/lexer.h"           // analyseur lexicla
#include "../Analyse_Lexicale_Automates/symbol_table.h"    // Table des symboles
#include "../Analyse_Lexicale_Automates/error_manager.h"   // handling errors
