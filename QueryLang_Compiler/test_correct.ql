...
-- SECTION 12: Case (USING CASEWHEN)
CASE
    CASEWHEN x < 10 THEN
        PRINT 'Small';
    CASEWHEN x >= 10 THEN
...
-- SECTION 16: Arithmetic (Line 148)
SET result INTEGER = (x + y) * 2 - 5;
SET sum FLOAT = price * 1.2;

-- SECTION 17-22: Conditions
WHEN x > 10 AND y < 50
THEN
    PRINT 'True';
END WHEN;
